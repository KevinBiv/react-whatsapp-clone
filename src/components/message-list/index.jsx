            ...
            <div className="header-section">
                <div className="top-header-section">
                    ...
                    <div className='header-section_icons'>
                        ...
                        <button onClick={onMenuBtnClicked}><svg className='menu' viewBox="0 0 24 24" width="24" height="24" class=""><path fill="currentColor" d="M12 7a2 2 0 1 0-.001-4.001A2 2 0 0 0 12 7zm0 2a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 9zm0 6a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 15z"></path></svg></button>
                        <div className={`menu-class ${isOpen ? 'visible':''}`} inert = {!isOpen ? "" : false}>
                            <ul>
                                <li><button>New group</button></li>
                                <li><button>Starred Messages</button></li>
